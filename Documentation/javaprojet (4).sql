...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 21 nov. 2017 à 09:22
...
('4 rue de paris', 75013, 'Paris', 1111111111, 1111111111, 'fouillard.arnaud@gmail.com', 1),
('4 rue de panam', 75012, 'Paris', 1111111111, 1111111111, 'fouillard.arnaud@gmail.com', 2),
('37 boulevard saint marcel', 75005, 'Paris', 1111111111, 1111111111, '.@gmail.com', 3),
('34 boulevard saint marcel', 75005, 'Paris', 1111111111, 1111111111, '.@gmail.com', 4),
('33 boulevard saint michel', 75005, 'Paris', 1111111111, 1111111111, '.@gmail.com', 5),
('35 boulevard saint michel', 75005, 'Paris', 1111111111, 1111111111, '.@gmail.com', 6);
...
('2001-11-14', 'Chateaudun', 'France', 'Homme', '2013-09-14', '', 1),
...
INSERT INTO `notes` (`moyenne`, `Matricule`, `idMatière`) VALUES
(17, 1, 1),
(17, 1, 2),
(17, 1, 3),
(17, 1, 4),
...
INSERT INTO `responsable` (`IdResponsable`, `Nom`, `Prenom`, `Adresse`, `Telephone`, `Email`, `Matricule`) VALUES
...
(8, 'Fouillard', 'jeanne', '3 rue du paradis', 680425283, 'fouillard.jeanne@hotmail.Fr', 1),
...
('Jean claude Troyes', 237464647, 'aucunes', 'aucunes', 'aucunes', 1),
('Jean Claude vendome', 237464647, 'aucunes', 'aucunes', 'aucunes', 2),
('Jean Pierre Rouvre', 237464647, 'aucunes', 'aucunes', 'aucunes', 3),
('Jean Claude Tonchan', 237464647, 'aucunes', 'aucunes', 'aucunes', 4),
('Jean Claude Georges', 237464647, 'aucunes', 'aucunes', 'aucunes', 5),
('Jean Claude Vendame', 237464647, 'aucunes', 'aucunes', 'aucunes', 6),
('Jean Claude Troyes', 237464647, 'aucunes', 'aucunes', 'aucunes', 7),
('Jean Claude Troyes', 237464647, 'aucunes', 'aucunes', 'aucunes', 8);
